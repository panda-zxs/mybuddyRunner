...
const targetDefinitions = {
  ...
  "windows-arm64": { coreOS: "windows-11-arm", desktopOS: "windows-2022", rustTarget: "aarch64-pc-windows-msvc", binary: "aioncore.exe", platform: "win32", arch: "arm64", rustflags: "-C target-feature=+crt-static", desktopCommand: "node scripts/build-with-builder.js arm64 --win --arm64" },
